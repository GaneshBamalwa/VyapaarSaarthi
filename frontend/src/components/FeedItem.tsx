  ...
  if (event.type === "hitl_event") {
    return (
      <div className="feed-item border border-yellow-500/20">
        <div className="w-8 h-8 rounded-lg flex items-center justify-center text-base shrink-0 bg-yellow-500/10 border border-yellow-500/20">
          🔔
        </div>
        <div className="flex-1 min-w-0">
  ...
  if (event.type === "order_event") {
    return (
      <div className="feed-item border border-indigo-500/20">
        <div className="w-8 h-8 rounded-lg flex items-center justify-center text-base shrink-0 bg-indigo-500/10 border border-indigo-500/20">
          📋
        </div>
        <div className="flex-1 min-w-0">
