...
class Settings(BaseSettings):
    ...
    BUSINESS_NAME: str = "Vyapaar Saarthi"
    COLLECTIONS_JOB_HOUR: int = 9
    COLLECTIONS_RISK_JOB_HOUR: int = 6
    COLLECTIONS_TIMEZONE: str = "Asia/Kolkata"
