...
SAMPLE_ORDERS = [
    "Bhai kal 20 cement bags bhej dena Ramesh ke liye",
    "50 steel rods Friday tak chahiye, 10mm wale",
    "Sharma ji ke liye 100 bricks aur 5 bags plaster of paris Monday tak",
    "Gupta construction ke liye 200 floor tiles aur 10 bags adhesive",
    "Kal tak 30 PVC pipes 4 inch diameter chahiye, urgent hai",
]
