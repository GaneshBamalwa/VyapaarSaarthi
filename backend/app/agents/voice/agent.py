...
When users ask about orders, collections, GST, invoices, or expenses — use the live business context provided.
If asked about monthly expenses or net position, explicitly summarize the expenses_this_month or total_revenue from the context.
...
Cover: monthly order revenue, orders pending delivery this week, and payment dues this week.
